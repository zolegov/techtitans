import{a as y,i as f,S as L,b,A as S}from"./assets/vendor-fc5788e3.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();const d=document.querySelector(".burger-icon"),u=document.querySelector(".close-modal"),i=document.querySelector(".modal-header"),m=()=>{i.classList.remove("is-active"),i.classList.add("is-hidden"),document.body.classList.remove("modal-open"),setTimeout(()=>{d.style.display="block",u.style.display="none"},500)};d.addEventListener("click",()=>{i.classList.add("is-active"),i.classList.remove("is-hidden"),d.style.display="none",u.style.display="block",document.body.classList.add("modal-open")});u.addEventListener("click",m);i.addEventListener("click",e=>{e.target===i&&m()});const q=document.querySelectorAll(".modal-content .header-menu-link");q.forEach(e=>{e.addEventListener("click",m)});const E={projectList:document.querySelector(".my-projects-list"),projectsItems:document.querySelectorAll(".my-projects-item"),projectsBtn:document.querySelector(".my-project-btn")},{projectList:R,projectsItems:p,projectsBtn:v}=E;v.addEventListener("click",h);let a=0;const k=3;function h(){for(let e=0;e<k;e++){if(a>=p.length){v.style.display="none";break}p[a].classList.remove("is-hidden"),a++}}h();const x="https://portfolio-js.b.goit.study/api";async function j(){return(await y.get(`${x}/reviews`)).data}const I=document.querySelector(".swiper-wrapper");async function O(e){const s=e.map(({author:n,avatar_url:r,review:t})=>`        
    <li class="reviews-list-item swiper-slide">
        ...
        </li>`).join("");I.insertAdjacentHTML("beforeend",s)}const g="/techtitans/assets/sprite-f4ef88fc.svg";document.querySelector(".reviews-list");const A=document.querySelector(".list-conteiner");addEventListener("load",async()=>{try{const e=await j();O(e)}catch{const s=`
            <div class="errorContainer">
                <h3 class="not-found-title">Oops, something went wrong...😱</h3>
                <p class="not-found-text">Reviews not found..</p>
            </div>
          `;A.innerHTML=s,f.show({message:"Oops, there are issues with showing reviews!",position:"topRight",backgroundColor:"#EF4040",transitionIn:"bounceInDown",transitionOut:"fadeOutUp",theme:"dark",timeout:5e3,closeOnClick:!0})}});const C=document.querySelector(".reviews-btn-right");C.style.backgroundColor=`${g}#icon-arrow-right`;new L(".mySwiper",{navigation:{nextEl:".reviews-btn-right",prevEl:".reviews-btn-left"},breakpoints:{1280:{slidesPerView:2}}});const P="https://portfolio-js.b.goit.study/api",l=b.create(`
